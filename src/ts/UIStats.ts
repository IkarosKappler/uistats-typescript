...
export class UIStats {
  ...
  static UIStatsChild = class {
    ...
    __installAsNewParent(evaluateFn: Evaluator) {
      ...
      this.uiStats.__applyKeyValue(
        this.keyName,
        this.uiStats.keyProps[this.keyName],
        evaluateFn(this.uiStats.observee[this.keyName])
      );
  ...
  // @private
  private __applyKeyValue(keyName: string, kProps, value) {
  ...
  private __updateChildElem(keyName, newElem) {
